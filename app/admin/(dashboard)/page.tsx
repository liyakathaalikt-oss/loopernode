  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <a href="/admin/blog" className="p-6 glass rounded-xl border border-white/10 hover:border-primary-500/50 transition-all cursor-pointer group hover:-translate-y-1">
        ...
        <a href="/admin/careers" className="p-6 glass rounded-xl border border-white/10 hover:border-primary-500/50 transition-all cursor-pointer group hover:-translate-y-1">
        ...
        <a href="/admin/media" className="p-6 glass rounded-xl border border-white/10 hover:border-primary-500/50 transition-all cursor-pointer group hover:-translate-y-1">
